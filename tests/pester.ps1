...
Remove-Module ContosoInfrastructure -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ContosoInfrastructure\ContosoInfrastructure.psd1"
Import-Module "$PSScriptRoot\..\ContosoInfrastructure\ContosoInfrastructure.psm1" -Force
