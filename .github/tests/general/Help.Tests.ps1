...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ContosoInfrastructure\functions", "$global:testroot\..\ContosoInfrastructure\internal\functions"),
	
	[string]
	$ModuleName = "ContosoInfrastructure",
...
$CommandPath = @(
    "$global:testroot\..\ContosoInfrastructure\functions"
    "$global:testroot\..\ContosoInfrastructure\internal\functions"
)
